...
class Calculadora {
    ...
    iniciarEventos() {
        this.botones.forEach/* itera sobre cada boton */(btn => { // Por cada botón
    ...
    // Método para establecer el operador   me obliga a hacer la operacion en el orden correcto
    ...
    calcularResultado() {
        if (this.operando1 !== '' && this.operando2 !== '') { // Si hay primer y segundo operando
            ...
            /* antes this.actualizarPantalla(this.resultado);
            this.limpiar(); */
        }
    }
